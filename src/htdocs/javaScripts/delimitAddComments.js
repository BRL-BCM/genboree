...
function dispatchWrapComments(elementName, delims)
{
  ...
  {   if ( document.getElementById("addnewComments") != null)
     document.getElementById("addnewComments").value = tempComment;
  ...
  {
    var field =document.getElementById("addnewComments");
    if (field != null)
    tempComment = document.getElementById("addnewComments").value;
    roughFormatText1("addnewComments", delims) ;

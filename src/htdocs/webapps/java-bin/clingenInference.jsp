...
<%
  // Constants
  final String underlyingPage = "/clingenInference/gridView.rhtml";
  String pageTitle = "ClinGenGrid" ;
   ...
   postContentBuff.append("&defaultGrp=Registries") ;
   postContentBuff.append("&defaultKb=AllRegistry") ;
   postContentBuff.append("&defaultEviColl=Evidence") ;
   postContentBuff.append("&defaultAllelesColl=Alleles") ;

...
<center>
	<font color="red"><strong>hello</strong></font><br><br>
	<%=warnMsg%><br><br>
</center>

Hello!  The time is now <%= new java.util.Date() %> In <%=warnTmo%> seconds you will be automatically forwarded to the start page. 

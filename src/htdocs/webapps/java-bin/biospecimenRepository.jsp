...
<%
  // Constants
  final String underlyingPage = "/exRNABiorepo/biorepository.rhtml";
  String pageTitle = "exRNA Biospecimen Virtual Repository" ;
   ...
   postContentBuff.append("&defaultGrp=exRNA Biosample Virtual Repository") ;
   postContentBuff.append("&defaultKb=exRNA - Biorepository Test") ;
   postContentBuff.append("&defaultColl=Biospecimens") ;
   // 1.c Get the string we will post IF thats what we will be doing

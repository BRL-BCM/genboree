...
<%
  // Constants
  final String underlyingPage = "/clinGenGrid/gridView.rhtml";
  String pageTitle = "ClinGenGrid" ;
   ...
   postContentBuff.append("&defaultGrp=ClingenAutomatedInference") ;
   postContentBuff.append("&defaultKb=ClingenInferenceEngineAlpha") ;
   postContentBuff.append("&defaultColl=evidence_v0.12") ;

...
<%
  // Constants
  final String underlyingPage = "/genboree/vgpConfig.rhtml" ;
  ...
  String pageTitle = "Genboree Discovery System - VGP" ;
  ...
  /* The following params will always need to be passed to the vgp rhtml page so that it can correctly
...
%>
    ...
    <head>
      ...
      <script type="text/javascript" src="/javaScripts/vgpConfigActions.js<%=jsVersion%>"></script>
      <script type="text/javascript" src="/javaScripts/vgpConfigUtilities.js<%=jsVersion%>"></script>
      <script type="text/javascript" src="/javaScripts/vgpConfigHelp.js<%=jsVersion%>"></script>

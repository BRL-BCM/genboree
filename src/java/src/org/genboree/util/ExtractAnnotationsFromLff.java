...
public class ExtractAnnotationsFromLff
{
    ...
    {
        System.out.print("usage: ExtractAnnotationsFromLff ");
        System.out.println("\n" +
    ...
    public static void main(String[] args) throws Exception
    {
        ...
        */
        ...
        HashMap elements = DirectoryUtils.transformFileWithNamesIntoHash(fileWithListAccessions);
        ...
        if(lffFile != null)
        {
            DirectoryUtils.extractFromLff(fileWithListAccessions, lffFile, fout);
        }

...
class RsyncPoller < BRL::Genboree::Pipeline::FTP::Pollers::Poller
  VERSION = "1.0"
  COMMAND_LINE_ARGS = {
  ...
  def makeHelper(host=nil, user=nil)
    return BRL::Genboree::Pipeline::FTP::Helpers::Rsync.new(host, user)
  end
end
end; end; end; end; end

if($0 and File.exist?($0) and BRL::Script::runningThisFile?($0, __FILE__))
  BRL::Script::main(BRL::Genboree::Pipeline::FTP::Pollers::RsyncPoller)
end

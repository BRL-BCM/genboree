...
module BRL ; module Genboree ; module Tools
  class StructuralVariantDetectionJobHelper < WorkbenchJobHelper
    TOOL_NAME = 'Structural Variant Detection'
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "wrapperBreakoutBreakpointDetect.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/#{CGI.escape("Structural Variation")}/BreakPoints/#{CGI.escape(analysisName)}/jobFile.json/data?"

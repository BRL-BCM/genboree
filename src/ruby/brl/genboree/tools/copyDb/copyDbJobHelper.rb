...
module BRL ; module Genboree ; module Tools
  class CopyDbJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "copyDbWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      workbenchJobObj.settings['srcDatabaseName'] = refseqRec['databaseName']
      workbenchJobObj.settings['srcRefSeqId'] = refseqRec['refSeqId']
      workbenchJobObj.settings['srcRefseqName'] = refseqRec['refseqName']
      workbenchJobObj.settings['srcGroupId'] = @grpApiHelper.tableRow(@grpApiHelper.extractPureUri(workbenchJobObj.inputs[0]))['groupId']
      workbenchJobObj.settings['mysqlHost'] = @genbConf.defaultUserDbHost

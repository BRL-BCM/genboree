...
module BRL ; module Genboree ; module Tools
  class RenameDbJobHelper < WorkbenchJobHelper
    ...
    def runInProcess()
      ...
      payload = {"data"=>{"name"=>newName, "entrypoints"=>nil, "gbKey"=>resp['gbKey'], "version"=>resp['version'], "description"=>resp['description'], "refSeqId"=>"", "species"=>resp['species'], "public" => resp['public']}}
      apiCaller.initInternalRequest(@rackEnv, @genbConf.machineNameAlias) if(@rackEnv)

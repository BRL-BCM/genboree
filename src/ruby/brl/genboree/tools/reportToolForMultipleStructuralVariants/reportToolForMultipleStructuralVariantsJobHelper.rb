...
module BRL ; module Genboree ; module Tools
  class ReportToolForMultipleStructuralVariantsJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "wrapperSVReport.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/#{CGI.escape("Structural Variation")}/Reports/#{CGI.escape(analysisName)}/jobFile.json/data?"

...
module BRL ; module Genboree ; module Tools
  class ExRNAMetadataUploadRulesHelper < WorkbenchRulesHelper
    
    TOOL_ID = 'exRNAMetadataUpload'
    ...
    #
    # When overriding, you first do retVal=super() so the code below is checked. If the super()

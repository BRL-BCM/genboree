...
module BRL ; module Genboree ; module Tools
  class DeleteTrackListsJobHelper < WorkbenchJobHelper

    TOOL_ID = 'deleteTrackLists'
    ...
    def runInProcess()
      ...
      if(trackListsDeleted != inputs.size)
        success = false
        @workbenchJobObj.context['wbErrorMsg'] = "#{inputs.size - trackListsDeleted} entity lists could not be removed. "
      end
      @workbenchJobObj.context['entityListsDeleted'] = trackListsDeleted
      return success
    end
    ...
    def getMessage(msgType, wbJobEntity)
      ...
      wbJobEntity.context['resourceType'] = 'trackEntityLists'

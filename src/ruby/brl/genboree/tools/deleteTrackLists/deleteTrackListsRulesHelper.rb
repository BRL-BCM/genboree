...
module BRL ; module Genboree ; module Tools
  class DeleteTrackListsRulesHelper < WorkbenchRulesHelper
    ...
    def warningsExist?(wbJobEntity)
      ...
      if(wbJobEntity.context['warningsConfirmed'])
        ...
        inputs = wbJobEntity.inputs
        msg = "The following track entity list(s) will be PERMANENTLY removed:"
        msg << "<ul>"
        inputs.each { |input|
          msg << "<li>#{trkEntityListApiHelper.extractName(input)}</li>"
        }
        msg << "</ul>  "

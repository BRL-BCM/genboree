...
module BRL ; module Genboree ; module Tools
  class RemoveDuplicatesJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "removeDuplicatesWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      workbenchJobObj.settings['removeDuplicates'] = workbenchJobObj.settings['removeDuplicates'] ? true : false
      workbenchJobObj.settings['keepUniqueMappings'] = workbenchJobObj.settings['keepUniqueMappings'] ? true : false
      workbenchJobObj.settings['removeSecondaryMappings'] = workbenchJobObj.settings['removeSecondaryMappings'] ? true : false

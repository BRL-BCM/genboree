...
module BRL ; module Genboree ; module Tools
  class MirbaseProfileGenerationRulesHelper < WorkbenchRulesHelper

    TOOL_ID = 'mirbaseProfileGeneration'
    ...
    def rulesSatisfied?(wbJobEntity, sectionsToSatisfy=[ :inputs, :outputs, :context, :settings ], toolIdStr=@toolIdStr)
      ...
      if(rulesSatisfied)
        ...
        # Check 1: The output db can be either one of: hg18, hg19 or mm9

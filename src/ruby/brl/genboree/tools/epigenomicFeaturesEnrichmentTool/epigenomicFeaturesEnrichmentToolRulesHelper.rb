...
module BRL ; module Genboree ; module Tools
  class EpigenomicFeaturesEnrichmentToolRulesHelper < WorkbenchRulesHelper
    ...
    def rulesSatisfied?(wbJobEntity, sectionsToSatisfy=[ :inputs, :outputs, :context, :settings ], toolIdStr=@toolIdStr)
      ...
      if(rulesSatisfied)
        ...
        if(sectionsToSatisfy.include?(:settings))
          ...
          rcscUri << "/file/#{CGI.escape("Structural Variation")}/EpigenomicEnrichment/#{CGI.escape(wbJobEntity.settings['analysisName'])}/jobFile.json?"

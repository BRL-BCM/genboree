...
module BRL ; module Genboree ; module Tools
  class TrackCopierJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "trackCopierWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      delTrks = workbenchJobObj.settings['deleteSourceTracksRadio']
      workbenchJobObj.settings['deleteSourceTracks'] = delTrks == 'move' ? true : false

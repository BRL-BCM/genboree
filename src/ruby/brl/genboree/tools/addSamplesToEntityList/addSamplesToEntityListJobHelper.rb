...
module BRL ; module Genboree ; module Tools
  class AddSamplesToEntityListJobHelper < WorkbenchJobHelper

    TOOL_ID = 'addSamplesToEntityList'
    ...
    def runInProcess()
      ...
      sampleEntityList = @sampleEntityListApiHelper.extractName(@workbenchJobObj.outputs[0])
      ...
      multiSelectInputList.each { |input|
        ...
        apiCaller = WrapperApiCaller.new(targetHost, "#{targetRsrcPath}/samples/entityList/#{CGI.escape(sampleEntityList)}?", @userId)

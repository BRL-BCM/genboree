...
module BRL ; module Genboree ; module Tools
  class MrfQuantifierJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "mrfQuantifierWrapper.rb"
    end
...
#     workbenchJobObj.settings['gtfDir'] = "#{@genbConf.clusterGTFDir}"
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/Mrfquantifier/#{CGI.escape(analysisName)}/jobFile.json/data?"

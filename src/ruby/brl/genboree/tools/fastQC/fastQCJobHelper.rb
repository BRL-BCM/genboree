...
module BRL ; module Genboree ; module Tools
  class FastQCJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "fastQCWrapper.rb"
    end
  ...
  # [+workbenchJobObj+]
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/FastQC/#{CGI.escape(analysisName)}/jobFile.json/data?"
      workbenchJobObj.settings['casava'] = workbenchJobObj.settings['casava'] ? true : false

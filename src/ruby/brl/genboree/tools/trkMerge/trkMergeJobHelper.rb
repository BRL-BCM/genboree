...
module BRL ; module Genboree ; module Tools
  class TrkMergeJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "trkCombineWrapper.rb" # Use the same tool wrapper as the combine tool. Only a few settings need to be hard-coded that will simulate the 'merge' only operation.
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      workbenchJobObj.settings['mergeAnnos'] = 'on'

...
module BRL ; module Genboree ; module Tools
  class WgsMicrobiomePipelineJobHelper < WorkbenchJobHelper

    TOOL_ID = 'wgsMicrobiomePipeline'


    # Instance vars that should be overridden to launch the job
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      super(toolIdStr, genbConf, dbu, args)
      self.class.commandName = "wgsMicrobiomePipelineWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      qualityFiltering = workbenchJobObj.settings['qualityFiltering']
      unless(qualityFiltering)
        workbenchJobObj.settings['--dontQualityFilterFlag'] = 'on'
      end
      workbenchJobObj.settings['--importSequencesFlag'] = 'on'

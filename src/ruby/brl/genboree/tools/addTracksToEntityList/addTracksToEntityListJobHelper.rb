...
module BRL ; module Genboree ; module Tools
  class AddTracksToEntityListJobHelper < WorkbenchJobHelper

    TOOL_ID = 'addTracksToEntityList'
    ...
    def runInProcess()
      ...
      trkEntityList = @trackEntityListApiHelper.extractName(@workbenchJobObj.outputs[0])

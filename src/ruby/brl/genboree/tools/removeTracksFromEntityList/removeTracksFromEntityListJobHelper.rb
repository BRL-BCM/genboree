...
module BRL ; module Genboree ; module Tools
  class RemoveTracksFromEntityListJobHelper < WorkbenchJobHelper

    TOOL_ID = 'removeTracksFromEntityList'
    ...
    def runInProcess()
      ...
      trkEntityList = @trackEntityListApiHelper.extractName(@workbenchJobObj.inputs[0])
      ...
      multiSelectInputList.each { |input|
        ...
        apiCaller = WrapperApiCaller.new(targetHost, "#{targetRsrcPath}/trks/entityList/#{CGI.escape(trkEntityList)}?", @workbenchJobObj.context['userId'])

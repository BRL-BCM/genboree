...
module BRL ; module Genboree ; module Tools
  class BowtieJobHelper < WorkbenchJobHelper
    TOOL_ID = 'bowtie'

    # Instance vars that should be overridden to launch the job
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      super(toolIdStr, genbConf, dbu, args)
      self.class.commandName = "bowtieWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/Bowtie/#{CGI.escape(analysisName)}/jobFile.json/data?"

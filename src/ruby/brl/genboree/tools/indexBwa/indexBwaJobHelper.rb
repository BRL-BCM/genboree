...
module BRL ; module Genboree ; module Tools
  class IndexBwaJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "indexBwaWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      # Removes unwanted settings
      @epArray = []
      @baseWidget = workbenchJobObj.settings['baseWidget']

...
module BRL ; module Genboree ; module Tools
  class TophatJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "tophatWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/TopHat/#{CGI.escape(analysisName)}/jobFile.json/data?"
      workbenchJobObj.settings['doUploadResults'] = workbenchJobObj.settings['doUploadResults'] ? true : false
      workbenchJobObj.settings['coverageSearch'] = workbenchJobObj.settings['coverageSearch'] ? true : false
      workbenchJobObj.settings['autoDetermineMateInnerDist'] = workbenchJobObj.settings['autoDetermineMateInnerDist'] ? true : false

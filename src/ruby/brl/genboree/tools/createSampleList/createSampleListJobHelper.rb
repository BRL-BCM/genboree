...
module BRL ; module Genboree ; module Tools
  class CreateSampleListJobHelper < WorkbenchJobHelper

    TOOL_ID = 'createSampleList'
    ...
    def runInProcess()
      ...
      sampleEntityListName = CGI.escape(@workbenchJobObj.settings['sampleEntityListName'])
      ...
      apiCaller = WrapperApiCaller.new(host, "#{rsrcPath}/samples/entityList/#{sampleEntityListName}?", @userId)

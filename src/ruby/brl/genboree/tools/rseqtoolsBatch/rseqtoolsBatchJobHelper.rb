...
module BRL; module Genboree; module Tools
  class RseqtoolsBatchJobHelper < WorkbenchJobHelper
    TOOL_ID = "rseqtoolsBatch"

    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      super(toolIdStr, genbConf, dbu, args)
      self.class.commandName = "rseqtoolsBatchWrapper.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      @jobFileCopyUriPaths << "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/RSEQtoolsBatch/#{CGI.escape(analysisName)}/jobFile.json/data?"

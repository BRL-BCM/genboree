...
module BRL ; module Genboree ; module Tools
  class DeleteSampleListsRulesHelper < WorkbenchRulesHelper
    ...
    def warningsExist?(wbJobEntity)
      ...
      if(wbJobEntity.context['warningsConfirmed'])
        ...
        inputs = wbJobEntity.inputs
        msg = "The following sample entity list(s) will be PERMANENTLY removed:"
        msg << "<ul>"
        inputs.each { |input|
          msg << "<li>#{sampleEntityListApiHelper.extractName(input)}</li>"
        }
        msg << "</ul>  "

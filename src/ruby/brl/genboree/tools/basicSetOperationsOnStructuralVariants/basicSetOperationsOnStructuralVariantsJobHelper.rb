...
module BRL ; module Genboree ; module Tools
  class BasicSetOperationsOnStructuralVariantsJobHelper < WorkbenchJobHelper
    ...
    def initialize(toolIdStr, genbConf=nil, dbu=nil, *args)
      ...
      self.class.commandName = "wrapperOperationsOnVariants.rb"
    end
    ...
    def cleanJobObj(workbenchJobObj)
      ...
      workbenchJobObj.settings['uploadLffFile'] = workbenchJobObj.settings['uploadLffFile'] ? true : false
      workbenchJobObj.settings['tgpBreakpoints'] = workbenchJobObj.settings['tgpBreakpoints'] ? true : false
      uri = URI.parse(output)
      @jobFileCopyUriPaths = "http://#{uri.host}/REST/v1/grp/#{CGI.escape(group)}/db/#{CGI.escape(db)}/file/#{CGI.escape("Structural Variation")}/#{CGI.escape("BreakPoint Operations")}/#{CGI.escape(analysisName)}/jobFile.json/data?"

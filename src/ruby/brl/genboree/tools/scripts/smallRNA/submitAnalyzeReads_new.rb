...
class SubmitAnalyzeReads
  ...
  def submit
    ...
    begin
      ...
      scriptFile.print "ruby analyzeReads_new.rb -r #{@readsFile} -o #{@outputDir} -t #{@targetGenome} -k #{@kWeight} "
...
class RunScript
  ...
  Mandatory Arguments: 
    ...
    -u  --usableReads #[Optional] (Y|N)by deault N. selected reads having lenght of >=10 and < =30

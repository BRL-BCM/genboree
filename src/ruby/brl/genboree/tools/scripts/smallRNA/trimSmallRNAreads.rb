...
class TrimSmallRNAs
  ...
  def work()
    ...
    tagReader = BRL::Util::TextReader.new(@tagsFile)
  ...
  def TrimSmallRNAs.processArguments()
		...
		optsArray =	[ ['--tagsFile',       '-t', GetoptLong::REQUIRED_ARGUMENT],
...
COMMAND LINE ARGUMENTS:
  --tagsFile          | -t   => small RNAs tags file
  --outputFile        | -o   => optional argument

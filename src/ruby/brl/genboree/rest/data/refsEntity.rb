...
module BRL ; module Genboree ; module REST ; module Data
  ...
  # Representation of a set of resource links relating to a particular resource.
  ...
  class RefsEntity < BRL::Genboree::REST::Data::AbstractEntity
    ...
    # [+refs+] [optional; default={}] The list of refs to represent.
    def initialize(refs={})
      super(true)
      update(refs)
    end
    ...
    # [+refs+] The new list of refs to represent.
    def update(refs)
      @refs = refs
    end
  ...
  end # class RefsEntity < BRL::Genboree::REST::Data::AbstractEntity

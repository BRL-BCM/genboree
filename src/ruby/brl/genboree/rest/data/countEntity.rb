...
module BRL ; module Genboree ; module REST ; module Data
  ...
  # CountEntity - Simple representation of the common count value.
  ...
  class CountEntity < BRL::Genboree::REST::Data::AbstractEntity
    ...
    # [+count+] [optional; default=0] The count value that will be represented.
    def initialize(doRefs=false, count=0)
      super(doRefs)
      update(count)
    end

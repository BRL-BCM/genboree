...
gbGroup = "exRNA Metadata Standards"
gbKbName = "exRNA Metadata"
gbDbName = "KB:exRNA Metadata"
...
newCollName = 'Studies'
exrnaStudiesModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/study.json"))
...
newCollName = 'Runs'
exrnaRunsModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/run.json"))
modelsHelper = mdb.modelsHelper
...
exrnaExperimentsModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/experiment.json"))
modelsHelper = mdb.modelsHelper
...
exrnaAnalysesModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/analysis.json"))
modelsHelper = mdb.modelsHelper
...
exrnaSubmissionsModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/submission.json"))
modelsHelper = mdb.modelsHelper
...
exrnaBiosamplesModel = JSON.parse( File.read( "/home/sailakss/sai/tabbedModels/models_9182014/biosample.json"))
modelsHelper = mdb.modelsHelper

		  ...
		  pashFiles.each { |pashFile|
			  ...
			  reader.each { |line|
				  ...
				  if(arrSplit.length >= 13)
					  ...
					  # Are we processing the result of hitsFilter with alignment in the pash record?
  			    if(arrSplit.length > 14)
  			      mismatches = arrSplit[8] 
  			      mismatchesAVP = "mismatches=#{mismatches}; "
              gaps = arrSplit[9]
              gapsAVP="gaps=#{gaps}; "
              gapBases = arrSplit[10]
              gapBasesAVP="gapBases=#{gapBases}; "
  			    else
  			      mismatchesAVP = ''
  			      gaps = arrSplit[8]
              gapsAVP="gaps=#{gaps}; "
              ...
              gapBasesAVP="gapBases=#{gapBases}; "
  				  ...
  				  # Create Forward Record - Ref is array 0-2 Target is array 3-5
  					forwardWriter.print  "#{@className}\t#{@nameForward}\t#{@type}\t#{@subtype}\t" +
  					                      ...
  					                      "#{mbsAVP}#{mismatchesAVP}#{gapsAVP}#{gapBasesAVP}\n"

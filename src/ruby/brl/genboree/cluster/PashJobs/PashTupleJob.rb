...
COMMAND LINE ARGUMENTS:
  ...
  --gbDatabase     | -D   => genboree database where the results are stored
  --gbUserName     | -U   => Genboree user name
  --gbGroup        | -G   => genbore group for the results lff track
  ...
  --subtype        | -s   => [optional] Override the LFF subtype value to use.
                           Defaults to 'Hit'.
  --SAMDirectory   | -S   => directory where the SAM format data and the metadata will be deposited

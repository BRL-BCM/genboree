...
PROGRAM DESCRIPTION:
  ...
  i.e. 
       ...
       ruby BRL_UCSC_downloader.rb -o hgdownload.cse.ucsc.edu -a hg18 -f chr1_chainPanTro2.txt.gz -d /users/ybai/work/Project1/test_Downloader -e ybai@ws59.hgsc.bcm.tmc.edu

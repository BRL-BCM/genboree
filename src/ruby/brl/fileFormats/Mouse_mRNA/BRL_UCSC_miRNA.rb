...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_miRNA.rb -r miRNA.txt.gz -t RNA -s miRNA -l 'Gene and Gene Prediction' -i /users/ybai/work/Mouse_mRNA -f miRNA_LFF.txt -d /users/ybai/work/Mouse_mRNA
"
end
  ...
  def convert(inputsHash) 
    ...
    begin
      ...
      reader.each { |line|
        ...
        # attri_comments
        f.print "smallRNAtype=; annotationColor=##{assigned_color}"
        # sequence (none)
        f.print "\t.\t"

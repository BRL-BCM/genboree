...
# PURPOSE
# ##############################################################################
# Simple: convert from UCSC mouse Repeat Masker file to equivalent LFF version
# and output 1+ tracks
...
PROGRAM DESCRIPTION:
  ...
  COMMAND LINE ARGUMENTS:
    --trackName             | -t    => Track name for Polymorphisms:Repeat Masker track.
                                       (type:subtype)
    --className             | -l    => Class name for Polymorphisms:Repeat Masker track.
  ...
  USAGE:
  i.e. BRL_UCSC_repeatMasker.rb -t 'Polymorphisms:Repeat Masker'  -l 'Structural Variants' -i /users/ybai/work/Human_Project5/Repeat_Masker -f chr1_rmsk_LFF.txt -d /users/ybai/work/Human_Project5/Repeat_Masker -o chr1_rmsk.txt.gz
"
end
    ...
    begin
     ...
     # Go through each line
      reader.each { |line|
        ...
        f.print "#{className}\t#{ff[10]}\t#{lffType}\t#{lffSubtype}\t#{ff[5]}\t#{ff[6]}\t#{ff[7]}\t#{ff[9]}\t.\t1.0\t.\t.\t"

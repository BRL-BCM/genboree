...
PROGRAM DESCRIPTION:
  ...
  COMMAND LINE ARGUMENTS:
    ...
    --trackName             | -t    => Track name for Variants:TCAG.v7 track.
                                       (type:subtype)
  ...
  USAGE:
  BRL_UCSC_CNPTCAG.rb -r variation.hg18.v7.mar.2009.txt -t Variants:TCAG.v7 -l 'Structural Variants' -i /users/ybai/work/Variants_TCAG -f variation.hg18.v7_LFF.txt -d /users/ybai/work/Variants_TCAG
"
end

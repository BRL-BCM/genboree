...
# PURPOSE
# ##############################################################################
# Simple: convert from UCSC cnpTuzun table to equivalent LFF version
...
def processArguments()
  optsArray = [
                ['--cnpTuzunFile', '-r', GetoptLong::REQUIRED_ARGUMENT],
...
PROGRAM DESCRIPTION:
  Converts from UCSC cnpTuzun table to equivalent LFF version.

  COMMAND LINE ARGUMENTS:
    --cnpTuzunFile       | -r    => UCSC cnpTuzun file to convert
    --trackName             | -t    => Track name for cnpTuzun track.
                                       (type:subtype)
    --className             | -l    => Class name for cnpTuzun track.
  ...
  USAGE:
  BRL_UCSC_cnpTuzun.rb -r cnpTuzun.txt.gz -t CNP:Tuzun -l 'Structural Variants' -i /users/ybai/work/Structural_Variants/converter_cnpTuzun_new -f cnpTuzun_LFF.txt -d /users/ybai/work/Structural_Variants/converter_cnpTuzun_new
"
end

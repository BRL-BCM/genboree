...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_cnpLocke.rb -r cnpLocke.txt.gz -t CNP:Locke -l 'Structural Variants' -i /users/ybai/work/Structural_Variants/converter_cnpLocke -f cnpLocke_LFF.txt -d /users/ybai/work/Structural_Variants/converter_cnpLocke
"
end

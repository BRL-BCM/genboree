...
#            ff[12] = ff[12].to_sym  #tInt
            ...
            f.print "#{className}\t#{ff[4]}.hapmapLdPhCeu\t#{lffType}\t#{lffSubtype}\t#{ff[1]}\t#{ff[2]+1}\t#{ff[3]+1}\t+\t.\t1.0\t.\t.\t"
...
#            ff[12] = ff[12].to_sym  #tInt
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{ff[4]}.hapmapLdPhChbJpt\t#{lffType}\t#{lffSubtype}\t#{ff[1]}\t#{ff[2]+1}\t#{ff[3]+1}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
...
#            ff[12] = ff[12].to_sym  #tInt
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{ff[4]}.hapmapLdPhYri\t#{lffType}\t#{lffSubtype}\t#{ff[1]}\t#{ff[2]+1}\t#{ff[3]+1}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)

...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_cnpIafrate2.rb -r cnpIafrate2.txt.gz -t CNP:Iafrate2 -l 'Structural Variants' -i /users/ybai/work/Structural_Variants/converter_cnpIafrate2 -f cnpIafrate2_LFF.txt -d /users/ybai/work/Structural_Variants/converter_cnpIafrate2
"
end

...
PROGRAM DESCRIPTION:
  ...
  COMMAND LINE ARGUMENTS:
    --trackName             | -t    => Track name for Micro:Satellites track.
                                       (type:subtype)
    --className             | -l    => Class name for Micro:Satellites track.
  ...
  USAGE:
  i.e. BRL_UCSC_microsatellites.rb -t 'Micro:Satellites'  -l 'Structural Variants' -i /users/ybai/work/Human_Project5/Microsatellites -f Microsatellites_LFF.txt -d /users/ybai/work/Human_Project5/Microsatellites -o microsat.txt.gz
"
end

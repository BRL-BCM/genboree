...
# PURPOSE
# ##############################################################################
# Simple: convert from UCSC cnpSharp2 table to equivalent LFF version
...
def processArguments()
  optsArray = [
                ['--cnpSharp2File', '-r', GetoptLong::REQUIRED_ARGUMENT],
...
PROGRAM DESCRIPTION:
  Converts from UCSC cnpSharp2 table to equivalent LFF version.

  COMMAND LINE ARGUMENTS:
    --cnpSharp2File       | -r    => UCSC cnpSharp2 file to convert
    --trackName             | -t    => Track name for cnpSharp2 track.
                                       (type:subtype)
  ...
  USAGE:
  BRL_UCSC_cnpSharp2.rb -r cnpSharp2.txt.gz -t CNP:Sharp2 -l 'Structural Variants' -i /users/ybai/work/Structural_Variants/converter_cnpSharp2 -f cnpSharp2_LFF.txt -d /users/ybai/work/Structural_Variants/converter_cnpSharp2
"
end

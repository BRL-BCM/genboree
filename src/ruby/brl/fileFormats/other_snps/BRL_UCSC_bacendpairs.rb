...
PROGRAM DESCRIPTION:
  Converts from UCSC BAC_EndPairs table to equivalent LFF version.
  ...
  USAGE:
  BRL_UCSC_bacendpairs.rb -r bacEndPairs.txt.gz -t BAC:EndPairs -l 'End Pairs' -i /users/ybai/work/Project5/BAC_EndPairs -f bacEndPairs_LFF.txt -d /users/ybai/work/Project5/BAC_EndPairs
"
end

...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  i.e. BRL_UCSC_mouse_simpleRepeats.rb -t 'Polymorphisms:Simple Repeats'  -l 'Structural Variants' -i /users/ybai/work/Project5/Simple_Repeats -f SimpleRepeats_LFF.txt -d /users/ybai/work/Project5/Simple_Repeats -o simpleRepeat.txt.gz
"
end

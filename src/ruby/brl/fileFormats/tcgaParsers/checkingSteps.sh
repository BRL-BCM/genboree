...
ADDCOMMASEPARATEDVPSTOLFF="/usr/local/brl/local/apache/ruby/brl/fileFormats/tcgaParsers/addCommaSeparatedVPsToLff.rb"
...
#--roiSequencingFileName $roiSequence --roiTableFile $roiToCoverage --sampleFileName $sampleFile --listOfGenesFileName $listOfGenesFileName --numberOfSamples $numberOfSamples
...
echo $SAMPLESTATS --sampleSequencingFileName $sampleSequencing --ampliconFileName  $ampliconFile --sampleFileName $sampleFile \
...
$ADDCOMMASEPARATEDVPSTOLFF --tabDelimitedFileName $roiToLoci --lffFileName $roiLffFileName --outPutFileName $tempFile
...
mv $tempFile $roiLffFileName
$ADDCOMMASEPARATEDVPSTOLFF --tabDelimitedFileName $ampliconToRoi --lffFileName $ampliconLffFileName --outPutFileName $tempFile
mv $tempFile $ampliconLffFileName
$ADDCOMMASEPARATEDVPSTOLFF --tabDelimitedFileName $ampliconToLociFileName --lffFileName $ampliconLffFileName --outPutFileName $tempFile
mv $tempFile $ampliconLffFileName

...
class AddCommaSeparatedVPsToLff

  def self.addCommaSeparatedVPsToLffFromTabDelimitedFile(optsHash)
#--tabDelimitedFileName  --lffFileName --outPutFileName
    methodName = "addCommaSeparatedVPsToLffFromTabDelimitedFile"
    ...
    mapping = AddCommaSeparatedVptoLffFromTabDelimitedFile.new(tabDelimitedFileName, lffFileName, outPutFileName)
    mapping.execute()
...
#--tabDelimitedFileName  --lffFileName --outPutFileName
BRL::FileFormats::TCGAParsers::AddCommaSeparatedVPsToLff.addCommaSeparatedVPsToLffFromTabDelimitedFile(optsHash)

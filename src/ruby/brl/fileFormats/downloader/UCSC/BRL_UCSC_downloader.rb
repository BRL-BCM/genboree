...
PROGRAM DESCRIPTION:
  ...
  USAGE: BRL_UCSC_downloader.rb -o host -a assembly_for_a_species -f fileList -e email_address
  i.e. BRL_UCSC_downloader.rb -o hgdownload.cse.ucsc.edu -a hg18 -f fosEndPairs.txt.gz -e ybai@ws59.hgsc.bcm.tmc.edu
"
end

...
PROGRAM DESCRIPTION:
  ...
  USAGE: BRL_Ensembl_downloader.rb -o host -a assembly_for_a_species -f fileList -e email_address
  i.e. BRL_Ensembl_downloader.rb -o ftp.ensembl.org -a homo_sapiens_core_47_36i -f *.gz -e ybai@ws59.hgsc.bcm.tmc.edu
"
end

...
ruby BRL_UCSC_downloader.rb -o hgdownload.cse.ucsc.edu -a hg18 -f hapmapLd*.txt.gz -d /users/ybai/work/Human_Project6/Expression_Regulation/HapMap_LD/ -e ybai@ws59.hgsc.bcm.tmc.edu
ruby BRL_UCSC_downloader.rb -o hgdownload.cse.ucsc.edu -a hg18 -f genomicSuperDups.txt.gz -d /users/ybai/work/Human_Project6/Expression_Regulation/Segmental_Dups/ -e ybai@ws59.hgsc.bcm.tmc.edu

...
# PURPOSE
# ##############################################################################
# Simple: convert from Database of Genomic Variants indel tables to equivalent LFF version
...
PROGRAM DESCRIPTION:
  Converts from UCSC Database of Genomic Variants indel table to equivalent LFF version.

  COMMAND LINE ARGUMENTS:
    --indelTCAGFile       | -r    => UCSC indel file to convert
    --trackName             | -t    => Track name for indelTCAG track.
                                       (type:subtype)
  ...
  USAGE:
  BRL_UCSC_INDELTCAG.rb -r indel.hg18.v3.txt.gz -t Indels:TCAG -l 'Structural Variants' -i /users/ybai/work/Variants_TCAG -f indel.hg18.v3_LFF.txt -d /users/ybai/work/Variants_TCAG
  BRL_UCSC_INDELTCAG.rb -r indel.hg17.v3.txt.gz -t Indels:TCAG -l 'Structural Variants' -i /users/ybai/work/Variants_TCAG -f indel.hg17.v3_LFF.txt -d /users/ybai/work/Variants_TCAG
"
end

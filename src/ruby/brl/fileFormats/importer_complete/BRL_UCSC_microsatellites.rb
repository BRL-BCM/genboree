...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  i.e. BRL_UCSC_microsatellites.rb -t 'Polymorphisms:Microsatellites'  -l 'Structural Variants' -i /users/ybai/work/Human_Project5/Microsatellites -f Microsatellites_LFF.txt -d /users/ybai/work/Human_Project5/Microsatellites -o microsat.txt.gz
"
end

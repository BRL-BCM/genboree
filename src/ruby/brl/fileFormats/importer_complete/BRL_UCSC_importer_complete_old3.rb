...
class MyImporter
  ...
  def import(inputsHash) 
	...
	c_directory_output VARCHAR (100) NOT NULL,
      ...
      sth.fetch do |row| 
        if(("#{assembly}" == "hg18" && "#{row[0]}" == "Fosmid:EndPairs") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Iafrate2") ||("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Locke") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Redon") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Sebat2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Sharp2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Tuzun") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Sharp2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Tuzun") || ("#{assembly}" == "hg18" && "#{row[0]}" == "CNP:Sharp2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "DEL:Conrad2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "DEL:Hinds2") || ("#{assembly}" == "hg18" && "#{row[0]}" == "DEL:Mccarroll"))

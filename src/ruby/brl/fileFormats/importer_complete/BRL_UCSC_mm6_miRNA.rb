...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_mm6_miRNA.rb -r miRNA.txt.gz -t RNA -s miRNA -l 'Gene and Gene Prediction' -i /users/ybai/work/Mouse_mm6-mRNA -f miRNA_LFF.txt -d /users/ybai/work/Mouse_mm6-mRNA
"
end

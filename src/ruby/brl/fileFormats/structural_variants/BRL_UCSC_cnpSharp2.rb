...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_cnpSharp2.rb -r cnpSharp2.txt.gz -t CNP:Sharp2 -l 'Structural Variants' -i /users/ybai/work/Project2/converter_cnpSharp2 -f cnpSharp2_LFF.txt -d /users/ybai/work/Project2/converter_cnpSharp2
"
end

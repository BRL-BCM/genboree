      ...
      if(inputsHash.key?('--cccTrendPvalBdFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            f.print "#{className}\t#{chromIndex}.cccTrendPvalBd\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
      ...
      if(inputsHash.key?('--cccTrendPvalCadFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalCad\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val
      ...
      if(inputsHash.key?('--cccTrendPvalCdFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalCd\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val
      ...
      if(inputsHash.key?('--cccTrendPvalHtFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalHt\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val
      ...
      if(inputsHash.key?('--cccTrendPvalRaFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalRa\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val
      ...
      if(inputsHash.key?('--cccTrendPvalT1dFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalT1d\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val
      ...
      if(inputsHash.key?('--cccTrendPvalT2dFile'))
        ...
        begin
          ...
          reader.each { |line|
            ...
            # Dump each linked feature as LFF
            ### class, name, type, subtype, entry point(chr), start, stop, strand, phase, score, qStart, qStop, attri_comments, seq, free_comments
            f.print "#{className}\t#{chromIndex}.cccTrendPvalT2d\t#{lffType}\t#{lffSubtype}\t#{ff[0]}\t#{chromStart}\t#{chromEnd}\t+\t.\t1.0\t.\t.\t"
            # attributes in order of useful information (in LFF anyway)
            ### val

...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_segmentaldups.rb -r genomicSuperDups.txt.gz -t 'Polymorphisms:Segmental Dups' -l 'Structural Variants' -i /users/ybai/work/Human_Project6/Variation_Repeats/Segmental_Dups -f genomicSuperDups_LFF.txt -d /users/ybai/work/Human_Project6/Variation_Repeats/Segmental_Dups
"
end

...
PROGRAM DESCRIPTION:
  ...
  USAGE:
  BRL_UCSC_gnfAtlas2.rb -r gnfAtlas2.txt.gz -t 'GNF:Atlas 2' -l 'Expression and Regulation' -i /users/ybai/work/Human_Project6/Expression_Regulation/GNF_Atlas2 -f gnfAtlas2_LFF.txt -d /users/ybai/work/Human_Project6/Expression_Regulation/GNF_Atlas2
"
end
